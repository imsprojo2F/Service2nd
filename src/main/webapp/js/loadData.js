...
function getProduct(typeId){
	$.ajax({
     ...
     function updateViews(id){
    	 $.ajax({
    		 url:'/Service/user/productUpdate',
    		 type:'post',
    		 dataType:'json',
    		 cache:false,
    		 data:{
